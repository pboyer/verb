...
declare module verb.core {
    ...
    export class BoundingBox {
         ...
         */
        constructor(pts?:Array<core.Data.Point>);
         ...
         * This BoundingBox for chainin
         */
        add(point:core.Data.Point): BoundingBox;
...
declare module verb.core {
    ...
    module Data {
        ...
        type KnotArray = Array<number>;


        /**
         * A `Plane` is simply an origin point and norma
         */
        export class Plane extends core.Serialization.SerializableBase {

            normal: Vector;

            origin: core.Data.Point;
         ...
         */
        export class Ray extends core.Serialization.SerializableBase {
         ...
         */
        export class NurbsCurveData extends core.Serialization.SerializableBase {
         ...
         * `verb.eval.Check` for that
         */
        export class NurbsSurfaceData extends core.Serialization.SerializableBase {
         ...
         */
        export class MeshData extends core.Serialization.SerializableBase {
         ...
         */
        export class PolylineData extends core.Serialization.SerializableBase {
         ...
         */
        export class VolumeData extends core.Serialization.SerializableBase {
...
declare module verb.core {
    ...
    module Intersections {
        ...
        export class CurveCurveIntersection {
            ...
            point0: core.Data.Point;

            /**
             * here the intersection took plac
             */
            point1: core.Data.Point;
        ...
        export class CurveSurfaceIntersection {
            ...
            curvePoint: core.Data.Point;

            surfacePoint: core.Data.Point;
        ...
        export class CurveTriPoint {
            ...
            constructor(u:number, point:core.Data.Point, uv:core.Data.UV);
        ...
        export class SurfacePoint {
            ...
            constructor(point:core.Data.Point, normal:core.Data.Point, uv:core.Data.UV, id?:number, degen?:boolean);
...
declare module verb.core {
    ...
    export class KdTree<T> {
        ...
        nearest(point:core.Data.Point, maxNodes:number, maxDistance:number): Array<core.Data.Pair<KdPoint<T>,number>>;
...
declare module verb.core {
    ...
    export class KdPoint<T> {
        ...
        constructor(point : core.Data.Point, obj: T);
    }
}
...
declare module verb.core {
    ...
    export class Mat {
         ...
         */
        static mul(a:number, b:core.Data.Matrix): core.Data.Matrix;
         ...
         */
        static mult(x:core.Data.Matrix, y:core.Data.Matrix): core.Data.Matrix;

        /**
         * Add two matrice
         */
        static add(a:core.Data.Matrix, b:core.Data.Matrix): core.Data.Matrix;

        /**
         * Divide each of entry of a Matrix by a constan
         */
        static div(a:core.Data.Matrix, b:number): core.Data.Matrix;

        /**
         * Subtract two matrice
         */
        static sub(a:core.Data.Matrix, b:core.Data.Matrix): core.Data.Matrix;

        /**
         * Multiply a `Matrix` by a `Vector
         */
        static dot(a:core.Data.Matrix, b:core.Data.Vector): core.Data.Vector;

        /**
         * Build an identity matrix of a given siz
         */
        static identity(n:number): core.Data.Matrix;
         ...
         */
        static solve(a:core.Data.Matrix, b:core.Data.Vector): core.Data.Vector;
    }
}
...
declare module verb.core {
    ...
    export class Mesh {
         ...
         * 
         */
        static getTriangleNorm(points:Array<core.Data.Point>, tri:core.Data.Tri): core.Data.Point;
         ...
         * 
         */
        static makeMeshAabb(mesh:core.Data.MeshData, faceIndices:Array<number>): verb.core.BoundingBox;
         ...
         * 
         */
        static sortTrianglesOnLongestAxis(bb:verb.core.BoundingBox, mesh:core.Data.MeshData, faceIndices:Array<number>): Array<number>;
    }
}
...
declare module verb.core {
    ...
    export class Minimizer {
        ...
        static uncmin(f:(Vector)=>number, x0:core.Data.Vector, tol?:number, gradient?:(Vector)=>core.Data.Vector, maxit?:number): Minimizer.MinimizationResult;
...
declare module verb.core {
    ...
    module Minimizer {
        ...
        export class MinimizationResult {
            ...
            solution: core.Data.Vector;

            value: number;

            gradient: core.Data.Vector;

            invHessian: core.Data.Matrix;
...
declare module verb.core {
    ...
    export class Trig {
        ...
        static isPointInPlane(pt:core.Data.Point, p:core.Data.Plane, tol:number): boolean;
...
declare module verb.core {
    ...
    export class Vec {
        ...
        static neg(arr : Array<number>) : Array<number>;
    
        static min(arr : Array<number>) : number;
    
        static max(arr : Array<number>) : number;
    
        static all(arr : Array<boolean>) : boolean;
    
        static finite(arr : Array<number>) : Array<boolean>;
    
        static onRay(origin : core.Data.Point, dir : core.Data.Vector, u : number) : Array<number>;
    
        static lerp(i : number, u : Array<number>, v : Array<number>) : Array<number>;
    
        static normalized( arr : Array<number> ): Array<number>;
    
        static cross(u : Array<number>, v : Array<number>) : Array<number>;
    
        static dist(a : Array<number>, b : Array<number> ) : number;
    
        static distSquared(a : Array<number>, b : Array<number> ) : number;
    
        static sum(a : Iterable<number>) : number;
    
        static addAll(a : Iterable<Array<number>>) : Array<number>;

        static addAllMutate(a : Array<Array<number>>): void;
    
        static addMulMutate(a : Array<number>, s : number, b : Array<number>): void;
    
        static subMulMutate(a : Array<number>, s : number, b : Array<number>): void;
    
        static addMutate(a : Array<number>, b : Array<number>): void;
    
        static subMutate(a : Array<number>, b : Array<number>): void;
    
        static mulMutate(a : number, b : Array<number>): void;
    
        static norm(a : Iterable<number> ) : number;
    
        static normSquared(a : Iterable<number> ) : number;
    
        static rep<T>(num : number, ele : T ) : Array<T>;

        static zeros1d(rows : number) : Array<number>;
    
        static zeros2d(rows : number, cols : number) : Array<Array<number>>;
    
        static zeros3d(rows : number, cols : number, depth : number) : Array<Array<Array<number>>>;

        static dot(a : Array<number>, b : Array<number>) : number;
    
        static add(a : Array<number>, b : Array<number>) : Array<number>;
    
        static mul(a : number, b : Array<number>) : Array<number>;
    
        static div(a : Array<number>, b : number ) : Array<number>;
    
        static sub(a : Array<number>, b : Array<number>) : Array<number>;
    
        static isZero( vec : Array<number> ) : boolean;
    
        static sortedSetUnion( a : Array<number>, b : Array<number>) : Array<number>;
    
        //a is superset, hence it is always longer or equal
        static sortedSetSub( a : Array<number>, b : Array<number>) : Array<number>;
...
declare module verb.eval {
    ...
    export class Analyze {
        ...
        static rationalCurveArcLength(curve : core.Data.NurbsCurveData, u : number, gaussDegIncrease : number): number;
...
declare module verb.eval {
    ...
    export class Divide {
         ...
         */
        static curveSplit(curve:core.Data.NurbsCurveData, u:number): Array<core.Data.NurbsSurfaceData>;
...
declare module verb.eval {
    ...
    export class Intersect {
         ...
         */
        static surfaces(surface0:core.Data.NurbsSurfaceData, surface1:core.Data.NurbsSurfaceData, tol:number ): Array<core.Data.NurbsSurfaceData>;
        ...
        bbtree0 : IBoundingBoxTree<number> = null ,
        bbtree1 : IBoundingBoxTree<number> = null ) : Array<Array<core.Intersections.MeshIntersectionPoint>>;
        ...
        static curveAndSurfaceWithEstimate(    curve : core.Data.NurbsCurveData,
                    ...
                    tol : number ) : core.Intersections.CurveSurfaceIntersection;
...
declare module verb.eval {
    ...
    export class Make {
         ...
         */
        static surfaceBoundaryCurves(surface:core.Data.NurbsSurfaceData): Array<core.Data.NurbsSurfaceData>;
...
declare module verb.eval {
    ...
    export class Modify {
         ...
         */
        static unifyCurveKnotVectors(curves:Array<core.Data.NurbsSurfaceData>): Array<core.Data.NurbsSurfaceData>;
...
declare module verb.eval {
    ...
    export class Tess {
        ...
        static rationalCurveAdaptiveSampleRange( curve : core.Data.NurbsCurveData, start, end, tol, includeU ) : Array<core.Data.Point>;
        ...
        static divideRationalSurfaceAdaptive( surface : core.Data.NurbsSurfaceData, options : AdaptiveRefinementOptions ): Array<AdaptiveRefinementNode>;

        static rationalSurfaceAdaptive( surface : core.Data.NurbsSurfaceData, options : AdaptiveRefinementOptions ) : core.Data.MeshData;
...
declare module verb.eval {
    ...
    export class AdaptiveRefinementNode {
        ...
        corners : Array<core.Intersections.SurfacePoint>;
        midPoints : Array<core.Intersections.SurfacePoint>;
        centerPoint : core.Intersections.SurfacePoint;
        splitVert : boolean;
        splitHoriz : boolean;
        horizontal : boolean;
        u05 : number;
        ...
        constructor( srf : core.Data.NurbsSurfaceData, corners : Array<core.Intersections.SurfacePoint>, neighbors : Array<AdaptiveRefinementNode>);
        ...
        evalSrf( u : number, v : number, srfPt : core.Intersections.SurfacePoint ) : core.Intersections.SurfacePoint;
    
        getEdgeCorners( edgeIndex : number ) : Array<core.Intersections.SurfacePoint>;
    
        getAllCorners( edgeIndex : number ) : Array<core.Intersections.SurfacePoint>;
...
declare module verb.geom {
    ...
    export class NurbsSurface extends core.Serialization.SerializableBase implements ISurface {
         ...
         * an array containing 4 elements, first 2 curves in the V direction, then 2 curves in the U directio
         */
        boundaries(options?:eval.AdaptiveRefinementOptions): Array<NurbsCurve>;

        /**
         * he async version of `boundaries
         */
        boundariesAsync(options?:eval.AdaptiveRefinementOptions): Promise<Array<NurbsCurve>>;
         ...
         * A MeshData objec
         */
        tessellate(options?:eval.AdaptiveRefinementOptions): core.Data.MeshData;

        /**
         * he async version of `boundaries
         */
        tessellateAsync(options?:eval.AdaptiveRefinementOptions): Promise<core.Data.MeshData>;
