...
verb.core._Mat = {};
verb.core._Mat.LUDecomp = function(lu,p) {
	this.LU = lu;
	this.P = p;
};
verb.core._Mat.LUDecomp.__name__ = ["verb","core","_Mat","LUDecomp"];
...
verb.exe.WorkerPool.prototype = {
	addWork: function(className,methodName,$arguments,callback) {
		var work = new verb.exe._WorkerPool.Work(className,methodName,$arguments);
...
verb.exe._WorkerPool = {};
verb.exe._WorkerPool.Work = function(className,methodName,args) {
	this.className = className;
	this.methodName = methodName;
	this.args = args;
	this.id = verb.exe._WorkerPool.Work.uuid++;
};
verb.exe._WorkerPool.Work.__name__ = ["verb","exe","_WorkerPool","Work"];
verb.geom = {};
...
verb.geom.NurbsCurve.prototype = {
	degree: function() {
	...
	,transformAsync: function(mat) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Modify,"rationalCurveTransform",[this._data,mat]).then(function(x) {
	...
	,pointAsync: function(u) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalCurvePoint",[this._data,u]);
	}
	,tangent: function(u) {
		return verb.eval.Eval.rationalCurveTangent(this._data,u);
	}
	,tangentAsync: function(u) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalCurveTangent",[this._data,u]);
	}
	...
	,derivativesAsync: function(u,numDerivs) {
		if(numDerivs == null) numDerivs = 1;
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalCurveDerivatives",[this._data,u,numDerivs]);
	}
	,closestPoint: function(pt) {
		return verb.eval.Analyze.rationalCurveClosestPoint(this._data,pt);
	}
	,closestPointAsync: function(pt) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalCurveClosestPoint",[this._data,pt]);
	}
	,closestParam: function(pt) {
		return verb.eval.Analyze.rationalCurveClosestParam(this._data,pt);
	}
	,closestParamAsync: function(pt) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalCurveClosestParam",[this._data,pt]);
	}
	,length: function() {
		return verb.eval.Analyze.rationalCurveArcLength(this._data);
	}
	,lengthAsync: function() {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalCurveArcLength",[this._data]);
	}
	...
	,paramAtLengthAsync: function(len,tolerance) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalCurveParamAtArcLength",[this._data,len,tolerance]);
	}
	...
	,divideByEqualArcLengthAsync: function(divisions) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Divide,"rationalCurveByEqualArcLength",[this._data,divisions]);
	}
	...
	,divideByArcLengthAsync: function(divisions) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Divide,"rationalCurveByArcLength",[this._data,divisions]);
	}
	,split: function(u) {
	...
	,splitAsync: function(u) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Divide,"curveSplit",[this._data,u]).then(function(cs) {
	...
	,reverseAsync: function() {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Modify,"curveReverse",[this._data]).then(function(c) {
	...
	,tessellateAsync: function(tolerance) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Tess,"rationalCurveAdaptiveSample",[this._data,tolerance,false]);
	}
};
...
verb.geom.NurbsSurface.prototype = {
	degreeU: function() {
	...
	,pointAsync: function(u,v) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalSurfacePoint",[this._data,u,v]);
	}
	,normal: function(u,v) {
		return verb.eval.Eval.rationalSurfaceNormal(this._data,u,v);
	}
	,normalAsync: function(u,v) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalSurfaceNormal",[this._data,u,v]);
	}
	...
	,derivativesAsync: function(u,v,numDerivs) {
		if(numDerivs == null) numDerivs = 1;
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Eval,"rationalSurfaceDerivatives",[this._data,u,v,numDerivs]);
	}
	,closestParam: function(pt) {
		return verb.eval.Analyze.rationalSurfaceClosestParam(this._data,pt);
	}
	,closestParamAsync: function(pt) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalSurfaceClosestParam",[this._data,pt]);
	}
	,closestPoint: function(pt) {
		return verb.eval.Analyze.rationalSurfaceClosestPoint(this._data,pt);
	}
	,closestPointAsync: function(pt) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Analyze,"rationalSurfaceClosestPoint",[this._data,pt]);
	}
	...
	,splitAsync: function(u,useV) {
		if(useV == null) useV = false;
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Divide,"surfaceSplit",[this._data,u,useV]).then(function(s) {
	...
	,reverseAsync: function(useV) {
		if(useV == null) useV = false;
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Modify,"surfaceReverse",[this._data,useV]).then(function(c) {
	...
	,isocurveAsync: function(u,useV) {
		if(useV == null) useV = false;
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Make,"surfaceIsocurve",[this._data,u,useV]).then(function(x) {
			return new verb.geom.NurbsCurve(x);
		});
	}
	...
	,boundariesAsync: function(options) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Make,"surfaceBoundaryCurves",[this._data]).then(function(cs) {
			return cs.map(function(x) {
				return new verb.geom.NurbsCurve(x);
			});
		});
	...
	,tessellateAsync: function(options) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Tess,"rationalSurfaceAdaptive",[this._data,options]);
	}
	,transform: function(mat) {
		return new verb.geom.NurbsSurface(verb.eval.Modify.rationalSurfaceTransform(this._data,mat));
	}
	,transformAsync: function(mat) {
		return verb.exe.Dispatcher.dispatchMethod(verb.eval.Modify,"rationalSurfaceTransform",[this._data,mat]).then(function(x) {
			return new verb.geom.NurbsSurface(x);
		});
	}
};
...
verb.exe._WorkerPool.Work.uuid = 0;
verb.Verb.main();
})(verb);
