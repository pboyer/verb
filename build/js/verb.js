...
var verb_core_SurfacePoint = $hx_exports["core"]["SurfacePoint"] = function(point,normal,uv,id,degen) {
	if(degen == null) {
		degen = false;
	}
	if(id == null) {
...
verb_eval_Intersect.curveAndSurfaceWithEstimate = function(curve,surface,start_params,tol) {
	...
	return new verb_core_CurveSurfaceIntersection(final_solution[0],[final_solution[1],final_solution[2]],verb_eval_Eval.rationalCurvePoint(curve,final_solution[0]),verb_eval_Eval.rationalSurfacePoint(surface,final_solution[1],final_solution[2]));
};
